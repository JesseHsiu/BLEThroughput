...
@interface BLEDeviceViewController : UIViewController<BTSmartSensorDelegate>
{
    ...
    NSDate *StartTime;
    NSDate *EndTime;
    NSDate *Each_Interval;
    NSTimeInterval TotalCostTime;
    
    IBOutlet UILabel *Label_NowStack;
    IBOutlet UILabel *Lable_TotalCostTime;
    IBOutlet UILabel *Lable_EachInterval;
}
